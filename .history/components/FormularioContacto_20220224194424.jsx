    ...
    const onSubmit = async (e) => {
        ...
        /* fetch('/api/contacto', {
          ...
          body: JSON.stringify({ nombre: valueNombre, email: valueEmail, telefono: valueTelefono, motivo: valueMotivo })
            ...
            console.log("resultado recibido despues del fetch:", res);
            console.log("resultado recibido: ", res);
            if(res.status === 200){
                alert("Email enviado correctamente! Se le constestara en la menor brevedad posible. Muchas gracias!")
                window.location.href= "/";
            }else alert("Problemas de envio.")
        }).catch(error => {
            console.log(error);
