...
export default function ContenedorImagenes(){
    return (
        <>
        <figure style={position:absolute;left:0;right:0;top:0;bottom:0}>
        ...
        {`
            .sopaImagenes{
                ...
                grid-gap: 3rem;
                align-items: center;
                animation: Marquee_marquee__3TZcw 30s linear infinite;
                -webkit-animation: Marquee_marquee__3TZcw 30s linear infinite;
            }
        `}
    </style>
        </>
