...
import { SecadosContextProvider } from "../context/secadoContext"
import { UserContextProvider } from "../context/userContext"
import { SecaderosContextProvider } from "../context/secaderoContext"

function App({ Component, pageProps }) {
  return (
    <UserContextProvider>
      <SecadosContextProvider>
        <SecaderosContextProvider>
          <Html>
            <Head>
              <meta
                name="viewport"
